...
# position linear of data in product's
x <- matrix(data = 4.469, nrow = 512, ncol = 512, byrow = FALSE, dimnames = NULL)
e1 <- colMeans(x, na.rm = FALSE, dims = 1L)
l1 <- colMeans(x, na.rm = FALSE, dims = 1L)
f1 <- colMeans(x, na.rm = FALSE, dims = 1L)
n1 <- colMeans(x, na.rm = FALSE, dims = 1L)
